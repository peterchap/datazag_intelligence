        ...
        <div class="cover">
            ...
            <div style="margin-top:80px;">
                <div style="display:inline-block; border:1px solid #00A3FF; color:#00A3FF; border-radius:20px; padding:6px 16px; font-size:11px; font-weight:700; letter-spacing:0.05em;">
                    Q2 2026 &middot; ATTACK SURFACE ASSESSMENT
                </div>
            ...
            <div style="display:grid; grid-template-columns:1fr 1fr; gap:24px; margin-top:60px;">
                <div style="background:#1E293B; border-radius:12px; border:1px solid #334155; padding:30px;">
                    <div style="display:flex; justify-content:space-between; align-items:center;">
                        ...
                        <div style="background:#0F172A; padding:4px 10px; border-radius:12px; font-size:11px; font-weight:600;">{self._get_trust_grade(platform_score)} &middot; {platform_score}/100</div>
                    </div>
                ...
                <div style="background:#1E293B; border-radius:12px; border:1px solid #334155; padding:30px;">
                    <div style="display:flex; justify-content:space-between; align-items:center;">
                        ...
                        <div style="background:#0F172A; padding:4px 10px; border-radius:12px; font-size:11px; font-weight:600;">{self._get_trust_grade(infra_score)} &middot; {infra_score}/100</div>
                    </div>
